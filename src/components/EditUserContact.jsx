	...
	return (
		<div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
			<div className="p-6 space-y-4">
				<h2 className="text-xl font-bold text-[#213] whitespace-nowrap">
				...
				<form onSubmit={handleProfileUpdate} className="space-y-4">
					...
					<button
						...
						className="w-full p-2 h-[40px] bg-green-700 hover:bg-green-800  text-white font-semibold rounded-[5px] disabled:opacity-70 disabled:cursor-not-allowed"
					>
